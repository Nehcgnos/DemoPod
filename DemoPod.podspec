...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Nehcgnos/DemoPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nehcgnos' => 'songc1992@outlook.com' }
  s.source           = { :git => 'https://github.com/Nehcgnos/DemoPod.git', :tag => s.version.to_s }
